...
//        themes.add(new Theme(6, "Bluesky", "bluesky"));
        themes.add(new Theme(7, "PDP Standard", "bootstrap"));
...
//        themes.add(new Theme(10, "Cruze", "cruze"));
        themes.add(new Theme(11, "PDP Dunkel", "dark-hive"));
        themes.add(new Theme(12, "PDP Mini", "delta"));
...
//        themes.add(new Theme(19, "Hot-Sneaks", "hot-sneaks"));
        themes.add(new Theme(20, "PDP Sunny", "humanity"));
